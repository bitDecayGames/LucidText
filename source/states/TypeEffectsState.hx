...
class TypeEffectsState extends FlxState {
	override public function create():Void {
		...
		var pauseText = new TypingGroup(FlxRect.get(20, FlxG.height / 2, FlxG.width - 40, FlxG.height / 2 - 20),
			"Pauses<pause /> can also be added<pause /> for dramatic<pause /> impact", options, 24);
